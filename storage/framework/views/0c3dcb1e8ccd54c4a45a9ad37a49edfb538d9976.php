...
<head>
    ...
    <title>
        <?php if(isset($general_setting)): ?>
                    <?php echo e($general_setting->name); ?>
...
<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
    ...
    ?>
        <link href="<?php echo e(asset('public/uploads/' . $general_setting->favicon)); ?>" rel="shortcut icon" type="image/png">
    <?php
        }
    ?>
...
::selection{
    color:#fff;
    background: <?php echo e($g_setting->theme_color); ?>;
}
...
.track-popup-body .form-control:focus {
    border-color: <?php echo e($g_setting->theme_color); ?>;
...
<body class="theme-blue <?php echo e($broadcast ? 'has-second-marquee' : ''); ?>">
    <div class="page-loader-wrapper">
        <div class="loader">
            <?php
            if(isset($general_setting)){ ?>
            <div class="m-t-30"><img src="<?php echo e(asset('public/uploads/' . $general_setting->preloader_photo)); ?>"
                    width="48" height="48" alt="<?php echo e($user_data->name); ?>"></div>
            <?php }else{ ?>
             <div class="m-t-30"><img src="<?php echo e(asset('public/uploads/preload.gif')); ?>"
    ...
    <div class="navbar-flex">
        ...
        <div class="navbar-left">
            <a href="https://hyloship.com/admin/dashboard">
                <img src="<?php echo e(asset('public/uploads/'.$general_setting->logo)); ?>" class="company-logo">
            </a>
        </div>
        ...
        <div class="navbar-center">
            <ul class="top-menu">
                 ...
                 <li class="<?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>">
                        ...
                        <li class="dropdown <?php echo e(request()->routeIs(
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(route('admin.order.all')); ?>">All Orders</a></li>
                                <li><a href="<?php echo e(route('admin.order.index')); ?>">New Orders</a></li>
                                <li><a href="<?php echo e(route('admin.order.return')); ?>">RTO Orders</a></li>
                                <li><a href="<?php echo e(route('admin.bulkorder.create')); ?>">Bulk Order Import</a></li>
                                <li><a href="<?php echo e(route('admin.ndr.ndr')); ?>">NDR</a></li>
                            </ul>
                        </li>
                ...
                <li class="dropdown <?php echo e(request()->routeIs(
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo e(route('admin.order.shipped_order')); ?>">Shipped</a></li>
                        <li><a href="<?php echo e(route('admin.order.manifest')); ?>">Manifest</a></li>

                        
                        <li>
                            <a href="<?php echo e(route('admin.payment.lostshipments')); ?>">
                                Lost Shipments
                            </a>
                        </li>
                    </ul>
                        ...
                        <!--<li class="<?php echo e(request()->routeIs('admin.ndr.ndr') ? 'active' : ''); ?>">-->
                        <!--    <a href="<?php echo e(route('admin.ndr.ndr')); ?>">NDR</a>-->
                        <!--</li>-->
                    ...
                    <li class="dropdown <?php echo e(request()->routeIs(
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(route('admin.order.remlist')); ?>">COD Remittance</a></li>
                            <li><a href="<?php echo e(route('admin.rate')); ?>">Rate Card</a></li>
                            <li><a href="<?php echo e(route('admin.wallet_transaction')); ?>">Shipping Charges</a></li>
                            <li><a href="<?php echo e(route('admin.weight')); ?>">Weight Reconciliation</a></li>
                            <li><a href="<?php echo e(route('admin.payment.walletreport')); ?>">Wallet Recharge</a></li>
                        ...
                        <li class="<?php echo e(request()->routeIs('admin.integration.channel') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.integration.channel')); ?>">Integration</a>
                        </li>

                        <!--<li class="<?php echo e(request()->routeIs('admin.weight') ? 'active' : ''); ?>">-->
                        <!--    <a href="<?php echo e(route('admin.weight')); ?>">Weight Reconciliation</a>-->
                        <!--</li>-->
                        ...
                        <li class="dropdown <?php echo e(request()->routeIs(
                            ...
                            <ul class="dropdown-menu">
                                <?php if(Auth::guard('admin')->user()->role_id == '1'): ?>
                                    <li><a href="<?php echo e(route('admin.integration.manage_courier')); ?>">Manage Courier</a></li>
                                    <li><a href="<?php echo e(route('admin.integration.courier_serviceable')); ?>">Courier Serviceable</a></li>
                                <?php endif; ?>
                                <li><a href="<?php echo e(route('admin.integration.courier_priority')); ?>">Courier Priority</a></li>
                            </ul>
                        </li>

                        <!--<?php if(Auth::guard('admin')->user()->role_id == '1'): ?>-->
                        <!--<li class="<?php echo e(request()->routeIs('admin.integration.pincode') ? 'active' : ''); ?>">-->
                        <!--    <a href="<?php echo e(route('admin.integration.pincode')); ?>">Pincodes</a>-->
                        <!--</li>-->
                        <!--<?php endif; ?>-->
                        

                        <li class="<?php echo e(request()->routeIs('admin.warehouse.list') ? 'active' : ''); ?>">
                            <a href="<?php echo e(route('admin.warehouse.list')); ?>">Warehouse</a>
                        </li>

                        <!--<li class="<?php echo e(request()->routeIs('admin.kyc') ? 'active' : ''); ?>">-->
                        <!--    <a href="<?php echo e(route('admin.kyc')); ?>">KYC</a>-->
                        <!--</li>-->

                        <!--<?php if(in_array(Auth::guard('admin')->user()->role_id, ['1','2'])): ?>-->
                        <!--<li class="<?php echo e(request()->routeIs('admin.role.user') ? 'active' : ''); ?>">-->
                        <!--    <a href="<?php echo e(route('admin.role.user')); ?>">Users</a>-->
                        <!--</li>-->
                        <!--<?php endif; ?>-->
                        ...
                        <li class="dropdown <?php echo e(request()->routeIs(
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(route('admin.reports.mis')); ?>">MIS Report</a></li>
                                <li><a href="<?php echo e(route('admin.reports.requestedreport')); ?>">Requested Report</a></li>
                                <li><a href="<?php echo e(route('admin.order.shipment_report')); ?>">Shipment Reports</a></li>
                            </ul>
                        </li>
    ...
    <a href="<?php echo e(route('admin.settings.ticket')); ?>" class="user-btn">
        <i class="fa fa-ticket"></i> Ticket
    </a>

    <!-- WALLET CLICKABLE -->
    <a href="<?php echo e(route('admin.payment.wallet')); ?>" class="wallet-pill">
        ₹ <?php echo e(number_format($user_data->wallet_blc,2)); ?>
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        <li class="dropdown-header">
            Seller ID: <?php echo e($user_data->user_code); ?>

        </li>
        
         <!-- <li><a href="/profile-change">My Profile</a></li> -->
         
        <li><a href="<?php echo e(route('admin.kyc')); ?>">KYC</a></li>
        ...
        <?php if(in_array(Auth::guard('admin')->user()->role_id, ['1','2'])): ?>
            <li><a href="<?php echo e(route('admin.role.user')); ?>">Users</a></li>
            <li><a href="<?php echo e(route('admin.orders')); ?>">Order list</a></li>
        <?php endif; ?>

        <?php if(Auth::guard('admin')->user()->role_id == '1'): ?>
            <li><a href="<?php echo e(route('admin.integration.pincode')); ?>">Pincodes</a></li>
        <?php endif; ?>
...
$(document).ready(function() {
    $(document).on('click', '#performTrack', function() {
        ...
        if (awb !== '') {
            $.ajax({
                url: "<?php echo e(route('admin.tracking.check')); ?>",
                type: 'GET',
                data: { awb: awb },
                beforeSend: function() {
                ...
                success: function(response) {
                    if (response.success) {
                        var url = "<?php echo e(route('admin.tracking', ['awb' => ':awb'])); ?>";
     ...
     $(document).ready(function() {
      ...
      // Function to parse month abbreviation to a number
        ...
        function broadcastclose(broadcast_id){
            $.get({
                url: "<?php echo e(route('admin.broadcast.hideuser')); ?>",
                data: { 
                    b_id: broadcast_id
...
<?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views/admin/admin_layouts.blade.php ENDPATH**/ ?>