 <?php $__env->startSection('admin_content'); ?> <?php $session = Auth::guard('admin')->user(); ?>
...
<script>
    function myFunction() {
        ...
        hideContent();
        $.ajax({
            url: "<?php echo e(route('admin.load')); ?>",
            type: 'GET',
            dataType: 'json',
...
<!--                <div id="navbar-animmenus">
                    <ul class="show-dropdown main-navbar">
                        ...
                        <li><a href="<?php echo e(route('admin.dashboard.shipment')); ?>" data-id="channel">Shipment Status</a></li>
                         <li><a href="<?php echo e(route('admin.dashboard.top')); ?>" data-id="top10">Top 10</a></li> 
                                        ...
                                        <div class="card card-raised loader-hidden">
                                            <div class="d-flex justify-content-center align-items-center" style="height: 100%; position: relative;">
                                                <div class="spinner" style="display: none;">
                                                    <img src="<?php echo e(asset('public/loader.gif')); ?>" style="width: 50px;">
                                                </div>
                                            </div>
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <div class="me-2">
                                                        <div class="display-5 font-size1em">
                                                            <a href="<?php echo e(route('admin.order.all', ['exceptnewcancel' => true, 'role_id' => $role_id])); ?>" target="_blank">
                                        ...
                                        <div class="card card-raised loader-hidden">
                                            ...
                                            <div class="card-body px-4 content">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <div class="me-2">
                                                        <div class="display-5 font-size1em">
                                                            <a href="<?php echo e(route('admin.order.all', ['delivered' => true, 'role_id' => $role_id])); ?>" target="_blank">
                                        ...
                                        <div class="card card-raised  loader-hidden">
                                            ...
                                            <div class="card-body px-4 content">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <div class="me-2">
                                                        <div class="display-5 font-size1em">
                                                            <a href="<?php echo e(route('admin.order.all', ['intrait' => true, 'role_id' => $role_id])); ?>" target="_blank">
                                        ...
                                        <div class="card card-raised  loader-hidden">
                                            ...
                                            <div class="card-body px-4 content">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <div class="me-2">
                                                        <div class="display-5 font-size1em">
                                                            <a href="<?php echo e(route('admin.order.all', ['rto' => true, 'role_id' => $role_id])); ?>" target="_blank">
                                                                <span id="rto"></span> (
                                                                <span id="rtopercent">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center" style="height: 100%; position: relative;">
                                            ...
                                            <div class="card-body px-4 content">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <div class="me-2">
                                                        <div class="display-5 font-size1em">
                                                            <a href="<?php echo e(route('admin.order.all', ['delivered' => true, 'role_id' => $role_id])); ?>" target="_blank" id="revenue"><?php echo e($revenue ?? ' '); ?></a>
                                                        </div>
                                ...
                                <div class="card card-raised h-100" style="border:1px solid">
                                    ...
                                    <div class="card-body p-4">
                                        <div class="row gx-4">
                                            ...
                                            <script src="<?php echo e(asset('/admin/assets/js/index_amchart.js')); ?>"></script>
...
<?php echo $__env->make('admin.admin_layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\admin\resources\views/admin/home3.blade.php ENDPATH**/ ?>