...
<?php endif; ?>
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select name="order_status" class="form-control">
                                            ...
                                            <option value='6' <?php if($o_st =='6'){echo 'selected';} ?> >RTO Delivered</option>
                                  	...
                                  	<div class="form-group col-md-2">
                                        ...
                                        <!--    <option value='3' <?php if($c_id =='3'){echo 'selected';} ?> >Bluedart</option>-->
                                        ...
                                        <!--</select>-->
                                         <select name="ship_courier_id" class="form-control">
                                            ...
                                            <option value='8' <?php if($c_id =='8'){echo 'selected';} ?> >Shadowfax</option>
                                            <!--<option value='9' <?php if($c_id =='9'){echo 'selected';} ?> >ATS</option>-->
                                            <option value='10' <?php if($c_id =='10'){echo 'selected';} ?> >Blitz</option>
                                            <option value='11' <?php if($c_id =='11'){echo 'selected';} ?> >Shree Maruti</option>
                                            <option value='12' <?php if($c_id =='12'){echo 'selected';} ?> >Pikndel</option>
    ...
    (function($) {
                    ...
                    $('form[action="<?php echo e(route('admin.order.all')); ?>"] select, form[action="<?php echo e(route('admin.order.all')); ?>"] input').each(function() {
                        ...
                        if (name && name != '_token') {
                            ...
                            if ($('#myForm input[name="' + name + '"]').length === 0) {
                                ...
                                $('#myForm input[name="' + name + '"]').val(value);
                            }
                        }
                    });
                }
        ...
        $('#exportAllBtn').on('click', function() {
            ...
            if (filterForm.find('input[name="download_all_flag"]').length === 0) {
                filterForm.append('<input type="hidden" name="download_all_flag" value="1">');
            }
            ...
            setTimeout(() => {
                filterForm.attr('action', originalAction);
                filterForm.attr('method', originalMethod);
            }, 1000);
        });
    // Select2 for Seller search
    $('#seller-search').select2({
