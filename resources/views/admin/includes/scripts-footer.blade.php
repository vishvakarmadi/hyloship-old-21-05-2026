...
<script src="{{ asset('admin/assets/vendor/flot-charts/jquery.flot.selection.js') }}"></script>
...
<script src="{{ asset('admin/assets/vendor/bootstrap-colorpicker/js/bootstrap-colorpicker.js') }}"></script> <!-- Bootstrap Colorpicker Js --> 
...
<script src="{{ asset('admin/assets/vendor/multi-select/js/jquery.multi-select.js') }}"></script> <!-- Multi Select Plugin Js -->
...
<script src="{{ asset('admin/assets/vendor/bootstrap-tagsinput/bootstrap-tagsinput.js') }}"></script> <!-- Bootstrap Tags Input Plugin Js --> 
<!--<script src="{{ asset('admin/assets/vendor/nouislider/nouislider.js') }}"></script>  noUISlider Plugin Js --> 
...
<script src="{{ asset('admin/assets/bootstrap-tagsinput.min.js') }}"></script>
