...
<!-- <link rel="stylesheet" href="{{ asset('public/admin/assets/vendor/bootstrap/css/bootstrap.min.css') }}"> -->
    <title>Hyloship Agreement</title>
    <style>
        body {
...
<body>
    <div class="card-body" >
        ...
        <p>1.7. <b>&ldquo;Courier Partner&rdquo;</b> shall mean an entity or a person engaged by the Hyloshipst for providing on ground courier services.</p>
        ...
        <p>1.11. <b>&ldquo;Identified Customer&rdquo;</b> means any person for whom the Company requests the Hyloshipst to arrange the delivery of Products.</p>
        ...
        <p>1.23. <b>&ldquo;Website&rdquo;</b> means the website of the Hyloshipst i.e. <b>www.hyloship.com</b> Except where the context requires otherwise, this Agreement shall be interpreted as follows:</p>
        ...
        <p>2.1 Subject to the terms and conditions of this Agreement, the Company hereby engages the Hyloshipst, on a non-exclusive basis and the Hyloshipst accepts such engagement, for providing the Services as per the terms of this Agreement.</p>
        <p>2.2 The Hyloshipst shall provide the Services on &ldquo;as and when required&rdquo; basis. The Company shall raise requests for any Service in the manner agreed in this Agreement or as may be mutually agreed between the Parties.</p>
        <p><b>3 <span style="text-decoration: underline;">MANNER OF PROVIDING THE SERVICES</span></b></p>
        <p>3.1 The Company shall request the Hyloshipst for the Services as and when required, either through a call on a designated phone number of the Hyloshipst or directly through the Website. Provided that the Company may also request for the Services in the manner provided on the Website.</p>
        <p>3.2 On the request made by the Company in the manner provided above, the Hyloshipst shall arrange a Field Executive to be available with the Company to provide the Services within a reasonable time depending on the availability of the Field Executives and other circumstances.</p>
        <p>3.3 The Company shall hand over the duly packaged Product to the Field Executive.</p>
        <p>3.4 The Field Executive will deliver the Product to the Identified Customer within a reasonable time or such time as is agreed with the Company. Provided however if there are any delays in delivery of the Product to the Identified Customer on account of bad weather, heavy or congested traffic or similar conditions then neither the Hyloshipst nor the Field Executive shall be responsible for any such delays.</p>
        ...
        <p>4.1 <b>Quality of Service.</b> The Hyloshipst shall make commercially reasonable endeavours that the Services are performed in a professional and competent manner, consistent with industry standards reasonably applicable to such services.</p>
        <p>4.2 <b>Performance of Services.</b> The Hyloshipst and not the Company, shall have the right to control the manner and means by which the Services are to be completed by the Hyloshipst pursuant to this Agreement. The Hyloshipst shall also retain the right to ensure that the Services are being performed according to the agreed specifications.</p>
        <p>4.3 The Hyloshipst make practically reasonable endeavours that:</p>
        <p>4.3.1 Field Executive shall be available with the Company within a reasonable time when required by the Company for providing the Service. However, the Hyloshipst shall reserve the right to reject the request made by the Company in cases of non-availability of Field Executives at that point of time.</p>
        ...
        <p>4.3.3 The money collected from the Identified Customers or any other person taking the delivery of the Product for the cash on delivery orders will be transferred to the Company&rsquo;s designated account as agreed with the seller. However, the Company shall not be held liable in case the cash on delivery amount has been delayed or misplaced by the Field Executive. The Company shall seek its claim, loss or any damages suffered from the Courier Partner directly, and in no way shall recover from the Hyloshipst or hold the Hyloshipst liable for the same. In this regard, the Company agrees that the Hyloshipst shall have the right to deduct the freight charges from the cash on delivery amounts received by the Hyloshipst, and then remit/reimburse the balance amount to the Company.</p>
        <p>4.4 It is expressly understood by the Parties that the Hyloshipst is a mere Hyloshipst to the Company and not in any other capacity whatsoever it may be called. It is further agreed to by the Parties that the Hyloshipst is not performing any activity or job or providing service on behalf of the Company which is tantamount to seller or retailer and or stockiest/distributor. The complete activity performed by the Hyloshipst under this Agreement is based on specific instructions given by the Company as part of the scope defined and from time to time.</p>
        <p><b>5 <span style="text-decoration: underline;">ROLES AND RESPONSIBILITIES OF THE COMPANY</span></b></p>
        <p>5.1 The Company shall ensure the availability of the Products before making a request to the Hyloshipst for a Field Executive.</p>
        <p>5.2 The Company shall duly intimate to the Hyloshipst of its change of ownership or change of management or change of legal status or its cessation of business.</p>
        ...
        <p>5.3.3 At the time of handing over the Products to the Field Executive, the Products are in good condition. If the Products are not in good condition at the time of handling the Products, the Field Executive, at his sole discretion, may refuse to accept the Product, without any liability to the Hyloshipst.</p>
        <p>5.3.4 The Company does not carry on activities, which are banned or illegal or immoral under the Applicable Laws.</p>
        <p>5.3.5 The Company is solely liable for Products shipped through Hyloshipsts. In the case of any Product mismatch/quality issue, Hyloshipst shall not be liable.</p>
        <p>5.3.6 The Company shall give adequate prior intimation to the Hyloshipst about the nature of the Products to be transported. The Company shall also intimate the Hyloshipst about whether such Products are to be delicately handled, whether the Products are of hazardous nature and other conditions with which the Products have to be handled in order to facilitate the Hyloshipst to make adequate arrangements for transport of such Products. This prior information is critical to the Hyloshipst. In the event of failure to provide such information, the Hyloshipst shall not be held liable for any damages and in addition, the Company shall be liable to indemnify the Hyloshipst for any actual and direct loss/injury suffered by its authorised personnel or to its vehicles on account of such hazardous nature of Products. Additionally, the Service Provider shall have the liberty to impose a penalty of INR 50,000/- per incident for any breach</p>
        <p>5.3.7 The Company shall provide proper prior intimation of the destination and details of the Identified Customer to whom/which the Products are to be delivered. Failure to provide proper information and/or any requisite information in relation to the Products, shall absolve the Hyloshipst of any liabilities towards loss from delay or mis-delivery. The Company agrees that it will be solely responsible for any breach of its obligations under this Agreement and for the consequences (including any loss or damage which the Company may suffer) of any such breach.</p>
        <p>5.3.8 The Company shall be solely and directly liable to its Identified Customers. The Hyloshipst shall be liable only to the Company to the extent and in the manner set out in the Agreement. To that effect, the Company shall ensure to protect and immediately indemnify the Hyloshipst against any such claims from Identified Customers of the Company.</p>
        ...
        <p>5.3.10 The Company shall be ready with the package in packed order when the Field Executive comes to receive the shipment, all pick-ups should be logged before the cut off time as directed by the customer support team of the Hyloshipst, and no pick up beyond the cut-off time of the Courier Partner shall be possible.</p>
        <p>5.3.11 The Company shall not engage in any activity that interferes with or disrupts the Services (or the servers and networks which are connected to the Services) of the Hyloshipst.</p>
        <p>5.4 In the event of any consumer complaint/dispute, the cases will be sent to the Company and it will be sole responsibility of the Company to resolve such cases within 24Hrs of receiving such cases. In case of any failure to resolve such cases, the Hyloshipst reserves the right to take appropriate action, legal or otherwise.</p>
        <p><b>6 <span style="text-decoration: underline;">SERVICE FEES</span></b></p>
        <p>6.1 <span style="text-decoration: underline;">Service Fee</span>. Starting from the Effective Date, as consideration in lieu of the Services provided by the Hyloshipst, the Company shall make a payment on a per order basis in the manner as set out in <b>Schedule I</b> of this Agreement. (&ldquo;<b>Service Fee</b>&rdquo;). The Hyloshipst may add new services for additional fees and charges or may proactively amend the Service Fees for existing services, at any time in its sole discretion by providing a notice, either on your dashboard or through email to the representative of the Company, which shall be considered as valid and agreed communication. Upon the Company not communicating any negative response/objection to the Hyloshipst to such notice, the Hyloshipst shall apply the modified Service Fee.</p>
        <p>6.2 <span style="text-decoration: underline;">Expenses</span>. For all the expenses to be incurred by the Hyloshipst for the purpose of providing the Services pursuant to this Agreement, the Hyloshipst shall submit an expense report with the Company. The expense report shall contain a brief summary/ breakup of the expenses incurred/to be incurred and receipts thereof. The expenses shall be paid in terms of Clause 6.3 (&ldquo;<b>Expenses</b>&rdquo;).</p>
        <p>6.3 <span style="text-decoration: underline;">Invoice</span>. The Hyloshipst is providing <b>Prepaid service</b>Amount will be deducted from the wallet or COD remittance for any Dues or for any outstanding amount of particular seller.
        <!--The Hyloshipst shall generate and submit invoices to the Company for the Service Fee and the Expenses once a month, along with the relevant documentary proofs (&ldquo;<b>Invoice</b>&rdquo;). Invoice needs to be paid within 15 days from the date of invoice.-->
        </p>
        ...
        <p>6.5 <span style="text-decoration: underline;">Tax deduction at source (TDS)</span>. The Service Fee would be subject to statutory TDS by the Company at the applicable rate. In the event of such deduction, Company will provide the Hyloshipst with the such certificate of TDS, requisite information and documentation in a timely manner as per the applicable rules so as to enable claim credits of the said TDS including without limitation a statutorily prescribed certificate in this regard.</p>
        <p>6.6 The Company is solely responsible for its payment of all taxes, legal compliances, and statutory registrations and reporting under Applicable Law. The Hyloshipst is in no way responsible for any of the Company&rsquo;s taxes or legal or statutory compliances.</p>

        <p>6.7 Payment. The payment by the Company to the Hyloshipst shall be made within [15 (Fifteen) days] from the date of Invoice. Delayed payment of Service Fees shall attract penal interest at the rate of 2.5% per month on all outstanding Service Fees.</p>
        <p>6.8 <span style="text-decoration: underline;">Right to Setoff</span>. The Company as security and compliance of its payment obligations to the Hyloshipst under this Agreement, hereby grants to the Hyloshipst the right to set-off against any moneys from time to time owing to or standing to the credit of the Company on the books of the Hyloshipst or in receipt of money received against cash on delivery of the Products, towards payment of any pending dues in terms of this Agreement. Regardless of the adequacy of any other remedy or rights of the Hyloshipst under this Agreement, the Hyloshipst, upon breach by the Company, or its employees/staffs or its agents, of any payment obligations to the Hyloshipst under this Agreement or any other agreement to which Company and the Hyloshipst are both parties, without notice to the Company, shall be entitled to set off all pending payment obligations of the Company to the Hyloshipst, then or thereafter existing, as the Hyloshipst may determine in its sole opinion and the Company hereby consents to such set-offs, appropriations or application.</p>
        <p><b>7 <span style="text-decoration: underline;">DISPUTES REGARDING PRODUCTS/SERVICES.</span></b></p>
        <p>7.1 The Hyloshipst shall not be responsible for any claims in connection with the late delivery of the Products. Provided the late delivery is reasonable and caused by unforeseen situations.</p>
        <p>7.2 The Hyloshipst shall not be responsible for any damage caused to the Product or if the Product is harmed in any other manner before it comes into the possession of the Field Executives.</p>
        <p>7.3 The Hyloshipst shall not be responsible for any damage caused to the Product in transit due to improper packaging of the Product.</p>
        <p>7.4 If any dispute or claim arises on the Hyloshipst for the cases mentioned hereinabove, then the Company shall indemnify the Hyloshipst in the manner specified in Clause 11 of this Agreement.</p>
        <p><b>8 <span style="text-decoration: underline;">INTELLECTUAL PROPERTY</span></b></p>
        <p>8.1 The Company represents that it is the sole and exclusive owner of its Intellectual Property and has and shall have full and sufficient rights to grant to the Hyloshipst, the right to use and permit the use of its Intellectual Property. The Company grants the right to use its Intellectual Property to the Hyloshipst solely for the purpose of providing the Services under the terms of this Agreement.</p>
        <p>8.2 Nothing contained in this Agreement constitutes a license in favor of the Company to use the Intellectual Property owned by the Hyloshipst such as, but not limited to trademarks, service marks or logos, and any use by the Company of the same shall be only with the prior written permission of the Hyloshipst, as the case maybe.</p>
        ...
        <p>9.2 The Company represents to the Hyloshipst that no claim or litigation is pending or threatened which would prevent it from entering into this Agreement and do such acts as may be agreed under this Agreement, any element thereof or any right therein and upon knowledge of any such claim or litigation by any party, the Company shall promptly notify the Hyloshipst.</p>
        ...
        <p>9.4 Except as set forth herein, Hyloshipst makes no representations, and hereby expressly disclaims all warranties, express or implied, regarding its Services or any portion thereof, including, without limitation, any implied warranty of merchantability or fitness for a particular purpose and implied warranties arising from course of dealing or course of performance.</p>
        ...
        <p>11.2 Notwithstanding anything to the contrary contained under this Agreement, in any event the Hyloshipst shall not be liable (whether in contract, warranty, tort, including but not limited to negligence, product liability or other theory) to the Company or any other person or entity for any indirect, incidental, punitive, special, consequential or exemplary damages (including damages for loss of revenues, loss of profit, or anticipated profits, loss of goodwill, loss of business or data or cost of procurement) arising out of or in relation to this Agreement even if the Hyloshipst has been advised of the possibility of damages. Hyloshipst&rsquo;s aggregate liability to the Company under this Agreement or under any Applicable Law or equity shall be limited solely to one month&rsquo;s Service Fee payable to the Hyloshipst.</p>
        <p>11.3 In the event the Company hands over or provides the aforesaid goods/shipments to the Field Executive, then the Hyloshipst or its Courier Partner shall not be responsible and liable for any loss, damage, theft or misappropriation of such Products even if Hyloshipst or the Courier Partner or the Field Executive has the knowledge of the same and even if such loss, damage, theft or misappropriation is caused due to any reason attributable to the Hyloshipst or the Courier Partner or the Field Executive.</p>
        ...
        <p>12.4 The termination rights of the Hyloshipst under this Clause 12 are in addition to, and not exclusive of, any other rights and remedies that the Hyloshipst may have hereunder, at Applicable Law or otherwise. The rights of the Hyloshipst under this Agreement shall continue to be in full force and effect until such time that the Hyloshipst is satisfied in full that all its claims and demands under the Agreement have been met to its satisfaction.</p>
        ...
        <p>14.2 <span style="text-decoration: underline;">Assignment.</span> The Company shall not assign its rights and obligations under this Agreement to a third party without the prior written consent of the Hyloshipst.</p>
        ...
        <p>14.4 <span style="text-decoration: underline;">Force Majeure.</span> Hyloshipst shall not be liable for any failure or delay in its performance under this Agreement due to reasons beyond its reasonable control, including acts of war, acts of God, earthquake, flood, riot, embargo, sabotage, pandemic, governmental act or failure of the Internet. The prices may be subject to hike in the event of pandemic or due to any unavoidable circumstances. No debit claims shall be accepted for any such events.</p>
        <p>14.5 <span style="text-decoration: underline;">Non-solicitation.</span> The Company agrees that during the Term and 2 (two) year thereafter, it shall, unless it secures the prior written permission of the Hyloshipst, directly or indirectly through its subsidiaries, affiliates or group companies, induce or attempt to induce any employee, officer, director, agent, independent contractor, customer, supplier or other Hyloshipst of the Hyloshipst to terminate its relationship with, or cease providing services or products to, or purchasing products from, the Company.</p>
        ...
        <p>14.10 <span style="text-decoration: underline;">Remedies.</span> The Company acknowledges, understands and agrees that should the Company breach any of its obligations contained in this Agreement, the Hyloshipst shall have the right to fully enforce this Agreement and the Hyloshipst shall be irreparably harmed and entitled to specific performance, including without limitation, an immediate issuance of a temporary restraining order or preliminary injunction (without posting a bond) enforcing this Agreement, in addition to a judgment for damages caused by any such breach, and to any other remedies provided for by applicable laws.</p>
        ...
        <p>14.16 <span style="text-decoration: underline;">Lost Claim.</span> In case of any loss or damage in the parcel caused due to the Hyloshipst, the Hyloshipst will provide the invoice value or INR 2000 whichever is lower. The loss or damage of the product will be considered only if there is damage in the product not the packaging. Any damage in the packaging will not entitle the other party to claim damages from the Hyloshipst.</p>
        <p>14.17 <span style="text-decoration: underline;">Sub-contractor.</span> The Hyloshipst shall have the right to appoint a third-party subcontractor for rendering the Services without any prior intimation of such appointment being provided to the Company.</p>
        ...
        <table style="width:100%">
            <tr style="border: 1px solid">
                <td style="border: 1px solid;width:50%;padding:1%"><b>For the Hyloshipst For Company</b></td>
                <td style="border: 1px solid;width:50%;padding:1%"><b>For Company</b></td>
            </tr>
            <tr style="border: 1px solid">
                <td style="border: 1px solid;width:50%;padding:1%"><b>Company Name: Aframax Pvt Ltd</b></td>
                <td style="border: 1px solid;width:50%;padding:1%"><b>Name: {{$session->company_name}}</b></td>
            </tr>
            <tr style="border: 1px solid">
                <td style="border: 1px solid;width:50%;padding:1%"><b>By: Rajesh Singhal</b></td>
        ...
        <br><br>
        <b>Accepted Date & Time: </b>{{$session->tc_accepted_at}}<br>
        <b>Accepted By: </b>{{$session->name}}<br>
         <b>IP: </b>{{$session->tc_accepted_ipaddress}}
        </div>
</body>
</html>
