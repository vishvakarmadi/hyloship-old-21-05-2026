...
<div class="row">
    <div class="col-lg-6 col-md-12">
        <div class="jumbotron">
            ...
            <a href="{{ asset('public/bulkremittance.xlsx') }}" download="" class="btn btn-secondary">Download Format</a>
        </div>
    </div>

    <div class="col-lg-6 col-md-12">
        <form class="product-form" action="{{ route('admin.order.storeremittance') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-header">
                    <h4>Import Remittance File</h4>
                </div>
