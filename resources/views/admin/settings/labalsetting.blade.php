            ...
            <form method="POST"
                ...
                <div class="form-section">
                    ...
                    <div class="check-row mt-2">
                        ...
                        <div class="check-label" style="font-weight: 700;">Hide Logo on Label</div>
                    </div>
                        ...
                        <div class="logo-upload-row">
                            ...
                            @if($s && $s->logo)
                                <img id="preview-logo-thumb"
                                     src="{{ $s && $s->logo ? asset('public/uploads/' . $s->logo) : asset('public/uploads/default.png') }}"
                                     alt="logo preview"
...
(function () {
    ...
    function trimText(str, len) {
        ...
        // --- LOGO ---
        var hideLogo = chk('chk_channel_logo');
