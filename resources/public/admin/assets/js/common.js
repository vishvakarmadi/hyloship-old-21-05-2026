...
$(document).ready(function() {
	...
	$(window).on('load resize', function() {
		if($(window).innerWidth() < 420) {
			$('.navbar-brand logo.svg').attr('src', '../assets/images/logo-icon.png');
		} else {
			$('.navbar-brand logo-icon.png').attr('src', '../assets/images/logo.svg');
		}
	});
...
$('.select-all').on('click',function(){
	...
	var countick = $('.checkbox-tick').filter(':checked').length;$('.order_selected_count').text(countick);
	});
